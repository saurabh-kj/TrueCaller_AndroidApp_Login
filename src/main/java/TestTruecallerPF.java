...
//  Permission pop-up
    ...
    @FindBy(id = "com.truecaller:id/nextButton")
    WebElement btn_confirm;  //can use it for Agree button
...
//        driver.switchTo().activeElement();
    ...
    public void login() throws InterruptedException {
        ...
        option_india.click();
        txt_number.sendKeys("8081301616");
        btn_confirm.click();
    ...
    public void completeProfile() throws InterruptedException {
        ...
        profileByType.click();
        //fill profile form
        txt_fName.sendKeys("Saurabh");
        txt_lName.sendKeys("Kumar");
        txt_email.sendKeys("saurabh.kumar@mailinator.com");
        btn_confirm.click();
    }
}
